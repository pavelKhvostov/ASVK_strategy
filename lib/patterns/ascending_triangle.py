"""Ascending Triangle (LONG) — зеркало descending_triangle (Bulkowski Ch.63).
...
Writes:
  G:\\ASVK\\data\\patterns\\ascending_triangle_hits_{SYM}_{start}_{end}.parquet
"""
...
MODE = "ascending_triangle"


def compute_ascending_triangle(df_1h, symbol):
...
def main() -> None:
    ...
    hits, stats = compute_ascending_triangle(df_1h, args.symbol)
