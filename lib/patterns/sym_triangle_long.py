"""Symmetrical Triangle LONG (вверх) — зеркало sym_triangle SHORT (Bulkowski Ch.66).
...
Writes:
  G:\\ASVK\\data\\patterns\\sym_triangle_long_hits_{SYM}_{start}_{end}.parquet
"""
...
PATTERN_NAME = "sym_triangle_long"
MODE = "sym_triangle_long"


def compute_sym_triangle_long(df_1h, symbol):
...
def main() -> None:
    ...
    hits, stats = compute_sym_triangle_long(df_1h, args.symbol)
