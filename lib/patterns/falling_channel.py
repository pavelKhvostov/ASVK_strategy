"""Falling Channel (LONG) — зеркало rising_channel.
...
Writes:
  G:\\ASVK\\data\\patterns\\falling_channel_hits_{SYM}_{start}_{end}.parquet
"""
...
PATTERN_NAME = "falling_channel"
MODE = "falling_channel"


def compute_falling_channel(df_1h, symbol):
...
def main() -> None:
    ...
    hits, stats = compute_falling_channel(df_1h, args.symbol)
